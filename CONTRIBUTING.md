...
3. Run direct tests first. Packaging changes require manifest/closure checks, two deterministic builds, checksum verification, and license/path/secret scans.
