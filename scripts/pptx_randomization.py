...
DEFAULT_MATRIX = ROOT / "artifacts" / "renderer-matrix" / "renderer-matrix.json"
DEFAULT_CONTENT = ROOT / "artifacts" / "pptx" / "manifests" / "pptx-builder-variant-placeholder-demo-20260826.content.json"
