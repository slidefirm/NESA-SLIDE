...
def render_slide(
    ...
    image_variant_attribute = (
        ' data-image-variant="raster"'
        if media_mode == "with-image" and media_treatment == "raster-background"
        else ""
    )
    ...
    if production is not None:
        ...
        return (
            ...
            f'{media_attribute}{media_treatment_attribute}{image_variant_attribute}{variant_attributes}>'
